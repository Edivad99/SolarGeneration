...
public class Translations {
    ...
    public static final Map<SolarPanelLevel, Advancement> SOLAR_HELMET_ADVANCEMENTS;

    static {
        SOLAR_PANEL_ADVANCEMENTS = new HashMap<>();
        SOLAR_HELMET_ADVANCEMENTS = new HashMap<>();
        for(var level : SolarPanelLevel.values()) {
            ...
            SOLAR_HELMET_ADVANCEMENTS.put(level, new Advancement(titleSolarHelmet, titleSolarHelmet + ".desc"));
        }
    }
