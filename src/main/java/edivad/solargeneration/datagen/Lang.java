...
public class Lang extends LanguageProvider {
  ...
  private void generateAdvancements() {
    ...
    add(Translations.ADVANCEMENTS_ROOT.desc(),
        "Start your solar-power journey by creating a Photovoltaic Cell.");

    var advancementsSolarPanel = new HashMap<SolarPanelLevel, Pair<String, String>>();
    advancementsSolarPanel.put(SolarPanelLevel.LEADSTONE,
        Pair.of("Start with the basics", "Craft a Leadstone Solar Panel."));
    advancementsSolarPanel.put(SolarPanelLevel.HARDENED,
        Pair.of("1 is better than 8", "Craft a Hardened Solar Panel."));
    advancementsSolarPanel.put(SolarPanelLevel.REDSTONE,
        Pair.of("Not enough energy", "Craft a Redstone Solar Panel."));
    advancementsSolarPanel.put(SolarPanelLevel.SIGNALUM,
        Pair.of("Looking for the signal", "Craft a Signalum Solar Panel."));
    advancementsSolarPanel.put(SolarPanelLevel.RESONANT,
        Pair.of("Escalation of power", "Craft a Resonant Solar Panel."));
    advancementsSolarPanel.put(SolarPanelLevel.ADVANCED,
        Pair.of("President of energy", "Craft a Advanced Solar Panel."));
    advancementsSolarPanel.put(SolarPanelLevel.ULTIMATE,
        Pair.of("Oh sun, I control you!", "Craft a Ultimate Solar Panel."));
    ...
    advancementsSolarHelmet.put(SolarPanelLevel.LEADSTONE,
        Pair.of("Using your head!", "Craft a Leadstone Solar Helmet."));
    advancementsSolarHelmet.put(SolarPanelLevel.HARDENED,
        Pair.of("8 helmets in 1", "Craft a Hardened Solar Helmet."));
    advancementsSolarHelmet.put(SolarPanelLevel.REDSTONE,
        Pair.of("Electric mind", "Craft a Redstone Solar Helmet."));
    advancementsSolarHelmet.put(SolarPanelLevel.SIGNALUM,
        Pair.of("Brain signals", "Craft a Signalum Solar Helmet."));
    advancementsSolarHelmet.put(SolarPanelLevel.RESONANT,
        Pair.of("Resonating tune", "Craft a Resonant Solar Helmet."));
    advancementsSolarHelmet.put(SolarPanelLevel.ADVANCED,
        Pair.of("Fancy crown", "Craft a Advanced Solar Helmet."));
    advancementsSolarHelmet.put(SolarPanelLevel.ULTIMATE,
        Pair.of("The Ultimate Helmet", "Craft a Ultimate Solar Helmet."));
