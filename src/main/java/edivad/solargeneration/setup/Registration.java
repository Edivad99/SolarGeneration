...
public class Registration {
    ...
    public static void init()
    {
        ...
        for(SolarPanelLevel level : SolarPanelLevel.values())
        {
            ...
            SOLAR_PANEL_TILE.put(level, TILES.register(level.getSolarPanelName(), () -> TileEntityType.Builder.of(() -> new TileEntitySolarPanel(level), SOLAR_PANEL_BLOCK.get(level).get()).build(null)));
